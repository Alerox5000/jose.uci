...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            reply_markup = inlineKeyboardMarkup(
                r1=[inlineKeyboardButton('📊 Canal del Dev 📊', url='https://t.me/freenube'),
...
def main():
    ...
    print('init bot.')
    #set in debug
    bot_token = '5736336758:AAFVay1EimOF8YUBjw9IUI_WmG8COTGqN1k'
